...
sections:
  ...
  - _template: "prose"
    body: |-
      ...
      6 months after genetics testing, BRCA2 confirmed. Immediate oophorectomy. Small ancillary lymph node involvement, biopsy confirmed ER2+ cancer. Leterozole stopped. Removal of lymph node and double mastectomy (right breast and reconstructed left breast and any remaining tissue) full new immediate implant recon. FEC for 6 months described as ‘mop up’ (allowed EC again as treating a separate cancer to the original one).
