...
url: "/research-and-trials/clinical-trials/"
date: "2019-10-12T10:57:27"
modified: "2024-10-10T23:25:43"
...
sections:
  - _template: "prose"
    body: |-
      ...
      The best way is to ask your consultant/oncologist about accessing a trial. If you are  

      willing and able to travel, let your consultant know and ask them to look further afield  

      for a suitable trial. You might find there is a suitable trial in a nearby city. Often the  

      clinical trials that metastatic patients need are funded by pharmaceutical companies,  

      and often they will pay your travel expenses so you won’t be out of pocket.

      Finding an up-to-date listing for MBC clinical trials has always been a challenge in the  

      UK. METUPUK have been creating a listing for patients since 2018. It is updated  

      monthly from a number of sources that clinicians also use. We have recently  

      converted the listing into Microsoft Power BI so that it is interactive dashboard.

      Tips for using the dashboard:

      - It’s slightly easier on a laptop than mobile due to the size of information you are  
  ...
  - _template: "prose"
    body: |-
      ...
      UK, Be Part of Research and the ISRCTN Registry. Last update October 2024
      ...
      <a href="https://bepartofresearch.nihr.ac.uk/results/search-results?query=metastatic%20breast%20cancer&location=&search=%257B%2522query%2522%253A%2522metastatic%2520breast%2520cancer%2522%252C%2522facetDef%2522%253A%257B%2522Gender%2522%253A%255B%255D%252C%2522Study%2520Status%2522%253A%255B%2522Recruiting%2522%255D%252C%2522Updated%2520Within%2522%253A%255B%255D%252C%2522Age%2520Range%2522%253A%255B%255D%252C%2522Health%2520Tag%2522%253A%255B%255D%257D%252C%2522rows%2522%253A%252210%2522%252C%2522offset%2522%253A%25220%2522%252C%2522openurl%2522%253A%2522yes%2522%252C%2522dist%2522%253A0%252C%2522sortBy%2522%253Anull%252C%2522sortOrder%2522%253Anull%257D" rel="noopener" target="_blank"><img src="/media/2019/10/nihr-logo-300x35.png" alt="Nihr logo" width="300" height="35" loading="lazy" decoding="async"></a>There is also a UK clinical trials database – Be Part of Research – which is updated on a regular basis.  If you want to see an up to date list of the <a href="https://bepartofresearch.nihr.ac.uk/results/search-results?query=metastatic%20breast%20cancer&location=&search=%257B%2522query%2522%253A%2522metastatic%2520breast%2520cancer%2522%252C%2522facetDef%2522%253A%257B%2522Gender%2522%253A%255B%255D%252C%2522Study%2520Status%2522%253A%255B%2522Recruiting%2522%255D%252C%2522Updated%2520Within%2522%253A%255B%255D%252C%2522Age%2520Range%2522%253A%255B%255D%252C%2522Health%2520Tag%2522%253A%255B%255D%257D%252C%2522rows%2522%253A%252210%2522%252C%2522offset%2522%253A%25220%2522%252C%2522openurl%2522%253A%2522yes%2522%252C%2522dist%2522%253A0%252C%2522sortBy%2522%253Anull%252C%2522sortOrder%2522%253Anull%257D" rel="noopener" target="_blank">metastatic breast cancer trials</a> that are currently running in the UK check the <a href="https://bepartofresearch.nihr.ac.uk/results/search-results?query=metastatic%20breast%20cancer&location=&search=%257B%2522query%2522%253A%2522metastatic%2520breast%2520cancer%2522%252C%2522facetDef%2522%253A%257B%2522Gender%2522%253A%255B%255D%252C%2522Study%2520Status%2522%253A%255B%2522Recruiting%2522%255D%252C%2522Updated%2520Within%2522%253A%255B%255D%252C%2522Age%2520Range%2522%253A%255B%255D%252C%2522Health%2520Tag%2522%253A%255B%255D%257D%252C%2522rows%2522%253A%252210%2522%252C%2522offset%2522%253A%25220%2522%252C%2522openurl%2522%253A%2522yes%2522%252C%2522dist%2522%253A0%252C%2522sortBy%2522%253Anull%252C%2522sortOrder%2522%253Anull%257D" rel="noopener" target="_blank">NIHR website.</a>
